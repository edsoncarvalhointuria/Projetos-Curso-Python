...
urlpatterns = [
    ...
    path('produto/<int:pk_produto>/', ver_produto, name='ver_produto'),
    path('produto/<int:pk_produto>/<int:pk_cor>', ver_produto, name='ver_produto'),
    path('carrinho/', carrinho, name='carrinho'),
    path('checkout/', checkout, name='checkout'),
    path('adicionarcarrinho/<pk_produto>/', adicionar_carrinho, name='adicionar_carrinho'),
    path('removercarrinho/<pk_produto>/', remover_carrinho, name="remover_carrinho"),
    ...
    path('exportarrelatorio/<str:solicitacao>', exportar_relatorio, name="exportar_relatorio"),
